...
class JoinsPercentage(Scenario):
    def __init__(self, main_directory: str, verbose: bool, percentage: float,
        ...
        ----------
        main_directory : str
            Root directory for generating instances of Joins Percentage.
        verbose : bool
    ...
    def path(self) -> str:
        ...
        -------
        path : str
            File path for the Joins Percentage's instance.
        """
        key = f'joins_perc_1-1_{self._percentage}'
    ...
    def _update_one_on_one(self, dataframe1: DataFrame, dataframe2: DataFrame)\
        ...
        for i, j in zip(list(sample1.index), list(sample2.index)):
            dataframe2.loc[j, 'id'] = dataframe1.loc[i, 'id']
    ...
    def _generate_scenario(self) -> bool:
        ...
        success : bool
            True if successfull, false otherwise
        """
        name: str = f'join_percentage_{self._percentage}'
        description: str = f'Join Percentage {self._percentage}% '
