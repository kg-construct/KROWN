...
class JoinsRelation(Scenario):
    def __init__(self, main_directory: str, verbose: bool, percentage: float,
        ...
        ----------
        main_directory : str
            Root directory for generating instances of Joins Relations.
        verbose : bool
    ...
    def path(self) -> str:
        ...
        -------
        path : str
            File path for the Joins Relations's instance.
        """
        key = f'joins_relations_{self._n}-{self._m}_{self._percentage}'
    ...
    def _generate_scenario(self) -> bool:
        ...
        success : bool
            True if successfull, false otherwise
        """
        name: str = f'join_relation_{self._n}_{self._m}_{self._percentage}'
        description: str = f'Join Relation {self._n}-{self._m} {self._percentage}% '
        iri: str = f'http://example.org/join-relation/{self._n}-{self._m}/{self._percentage}/'
